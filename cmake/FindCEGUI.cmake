...
FIND_PATH(CEGUI_INCLUDE_DIR CEGUI/CEGUI.h
  PATHS $ENV{CEGUIDIR}
  PATH_SUFFIXES /include /cegui/include /include/CEGUI CEGUI.framework/Headers /include/cegui-0
)
...
FIND_LIBRARY(CEGUI_LIBRARY_DEBUG
  NAMES
    CEGUIBased CEGUIBase_d CEGUIBaseD CEGUIBase_D CEGUIBase-0_d
    CEGUId CEGUI_d CEGUID CEGUI_D
  PATHS $ENV{CEGUIDIR}
  PATH_SUFFIXES lib bin
)

FIND_LIBRARY(CEGUI_OPENGL_LIBRARY_OPTIMIZED
	NAMES CEGUIOpenGLRenderer-0
	PATHS $ENV{CEGUIDIR}
	PATH_SUFFIXES lib bin
)

FIND_LIBRARY(CEGUI_OPENGL_LIBRARY_DEBUG
...
HANDLE_LIBRARY_TYPES(CEGUI_OPENGL)

SET(CEGUI_LIBRARIES ${CEGUI_LIBRARY} ${CEGUI_OPENGL_LIBRARY})

MARK_AS_ADVANCED(
  CEGUI_INCLUDE_DIR
  CEGUI_LIBRARY_OPTIMIZED
  CEGUI_LIBRARY_DEBUG
  CEGUI_OPENGL_LIBRARY_OPTIMIZED
  CEGUI_OPENGL_LIBRARY_DEBUG
)
