...
typedef GenericNetMessage<1777, Vector3i> NetRequestChunkDataMessage; // varNames: "coordinate"
typedef GenericNetMessage<1778, Vector3i> NetStopChunkTrackingMessage; // varNames: "coordinate"
...
public:
    ...
    typedef Vector3i ChunkCoordinates;
    static ChunkCoordinates positionToChunk(const Vector3& pos);
    static Vector3 chunkToPosition(const Vector3i& pos);
